...
def iterate_over_frames(frequency):
    ...
    for row in frames_df.iterrows():
        ...
        # print(vid_seq_name)
        # print('\n')
        im = process_image(frame_path, (width, height, channels), standardize=False,
...
if __name__ == '__main__':
    ...
    frames_dir = '../data/lps/random_clips_lps/jpg_224_224_25fps/'
    ...
    output_dir = '../data/lps/random_clips_lps/jpg_224_224_25fps_OF_magnitude_2fpsrate/'
