...
def Inception_Inflated3d(include_top=True,
    ...
    inputs = img_input
    # create model
    data_str = 'flow' if 'flow' in weights else 'rgb'
    model = Model(inputs, x, name='i3d_inception_{}'.format(data_str))
    ...
    if weights in WEIGHTS_NAME:
        if weights == WEIGHTS_NAME[0]:   # rgb_kinetics_only
            if include_top:
                ...
                model_name = 'i3d_inception_rgb_kinetics_only_no_top.tf'
            ...
            if include_top:
                ...
                model_name = 'i3d_inception_flow_kinetics_only_no_top.tf'
